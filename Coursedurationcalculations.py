course_duration = int (input("Please enter your course duration in seconds: \n"))
# Convert type into int
#int_duration = int(course_duration)
# Calculate the number of course hours
hours = course_duration // 3600  # Floor division sign // gives you the integer number only
remaining_seconds_after_hours = course_duration % 3600  # Seconds remaining after calculating hours
